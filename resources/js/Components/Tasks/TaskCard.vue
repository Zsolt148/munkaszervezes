<template>
    <v-card
        outlined
        class="canban--card mx-auto list-group-item mb-2"
    ...
    >
        ...
        <div>
            ...
            <div class="canban--card-data">
                ...
                <div class="canban--card-park" v-if="task.park">
                    {{ task.park.name }} <br>
                </div>
            </div>
            ...
            <div class="canban--card-deadline" v-if="task.date">
                <v-icon small>mdi-calendar</v-icon>
                {{ trans('Date') }}: {{ dateFormat(task.date, 'YYYY.MM.DD') }}
            </div>
