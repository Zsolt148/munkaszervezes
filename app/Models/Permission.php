...
use App\Helpers\Interfaces\PermissionInterface;
...
class Permission extends Model implements PermissionInterface
{
     ...
     * @throws \Spatie\Permission\Exceptions\PermissionDoesNotExist
     */
    public static function findById(int $id, $guardName = null): PermissionInterface
    {
        $guardName = $guardName ?? Guard::getDefaultName(static::class);
     ...
     */
    protected static function getPermission(array $params = []): ?PermissionInterface
    {
